...
public class BinarySearchTree<E extends Comparable<E>> implements SearchTree<E> {
     ...
     *
     * @post The data field inserted is set true if the item is added to the tree,
    ...
    private Node<E> deletePrime(Node<E> localRoot, E item) {
        ...
        int compResult = item.compareTo(localRoot.data);
        if (compResult < 0) {
            // item is smaller than localRoot.data. Keep search on left, if not found return
            // null
     ...
     * @param parent The parent of possible inorder sucessor (is)
     ...
     * performed by the exercise. Also, the toString method of the BinaryTree class
     * would be hidden and it is useful to verify some of the tests.
     */
    ...
    //2a. Implement the code for void preOrder()
    ...
    // 2b. Implement the code for void postOrder()
    ...
    // 2c. Implement the code to count the leaf nodes int leafCount()
    ...
    public static void main(String args[]) {
        ...
        List<Integer> treeList = Arrays.asList(55, 45, 47, 43, 54, 58, 76, 71, 50, 60, 68,80, 91);
        BinarySearchTree<Integer>  tree = new BinarySearchTree<>();
        for(int i = 0; i < treeList.size(); i++){
            tree.add(treeList.get(i));
        }
        ...
        tree.postOrder();
        System.out.println();
        System.out.println("The number of leaf nodes: " + tree.leafCount());
